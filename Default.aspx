<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DevArt._Default" %>

<asp:Content ID="TitleContent" ContentPlaceHolderID="TitleContent" runat="server">DevArt - Elevate Your Sanctuary</asp:Content>
                ...
                <div class="community-content">
                    ...
                    <div class="newsletter-form">
                        ...
                        <asp:Button ID="btnSubscribe" runat="server" Text="Subscribe" CssClass="newsletter-btn"
                            ValidationGroup="Newsletter" OnClick="btnSubscribe_Click" />
                    </div>
                    <%-- The newsletter box has its own validation group, so it never
                         blocks any other post-back on the page. --%>
                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server"
                        ControlToValidate="txtEmail" ValidationGroup="Newsletter"
                    ...
                    <asp:CustomValidator ID="cvEmail" runat="server"
                        ...
                        ErrorMessage="This email is already subscribed to the DevArt newsletter."
                        Text="This email is already subscribed." />
                    <asp:Panel ID="pnlSubscribed" runat="server" Visible="false" CssClass="form-alert success" style="margin-top:12px;">
                        <asp:Literal ID="litSubscribed" runat="server" />
                    </asp:Panel>
