...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="auth-shell">
        <asp:Panel ID="pnlCard" runat="server" CssClass="auth-card" DefaultButton="btnLogin">
            ...
            <h1 class="auth-title-serif">Admin Panel</h1>
            <p class="auth-subtitle-lead">Store staff only. Sign in to manage store operations.</p>
            ...
            <div class="form-grid">
                ...
                <div class="form-field full">
                    ...
                    <div class="input-icon-group">
                        ...
                        <asp:TextBox ID="txtPassword" runat="server" CssClass="form-input has-right-icon"
            ...
            <p class="auth-foot" style="margin-top: 22px; font-weight: 500;">
                Shopping instead? <a href="<%= ResolveUrl("~/Login.aspx") %>" class="auth-link-brown" style="font-weight: 700;">Customer login</a>
            </p>
        </asp:Panel>
    </main>
