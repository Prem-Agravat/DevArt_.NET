<%@ Page Title="Profile" Language="C#" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="DevArt.Profile" %>
...
<head runat="server">
    ...
    <title>DevArt - User Profile</title>
        ...
        <main class="home-page">
            <section class="about-section">
                <div class="about-container">
                    <h1 class="about-title">User Account</h1>
                    <p class="about-subtitle">Manage your profile, wishlist, and recent orders.</p>
                    
                    <div class="about-content-card" style="text-align: center;">
                        <p>Please log in or register an account to view your user profile and settings.</p>
                    </div>
                </div>
            </section>
        </main>
