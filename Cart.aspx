<%@ Page Title="Cart" Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="DevArt.Cart" %>
        ...
        <main class="home-page">
            <section class="about-section">
                <div class="about-container">
                    <h1 class="about-title">Your Cart</h1>
                    <p class="about-subtitle">Review your selected items before checkout.</p>
                    
                    <div class="about-content-card" style="text-align: center;">
                        <p>Your shopping cart is currently empty. Visit Our Collection to add premium decor items to your cart.</p>
                    </div>
                </div>
            </section>
        </main>
