<%@ Page Title="Categories" Language="C#" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="DevArt.Categories" %>
        ...
        <header class="site-header">
            <div class="header-container">
                ...
                <nav class="main-nav">
                    ...
                    <a href="Categories.aspx" class="nav-link active">Categories</a>
        ...
        <main class="home-page">
            <section class="about-section">
                <div class="about-container">
                    <h1 class="about-title">Product Categories</h1>
                    <p class="about-subtitle">Explore our curated collections of artisanal handicrafts.</p>
                    
                    <div class="about-content-card" style="text-align: center;">
                        <p>Browse through our collections of Torans, Cushion Covers, Sofa Covers, and Bedsheets. More categories coming soon!</p>
                    </div>
                </div>
            </section>
        </main>
